[CinematicTrackAttribute(name:"Anime AttachToSlot Track", description:"Track used for attaching entities to Slot Manager")]
class AnimeAttachToSlotManagerCinematicTrack : CinematicTrackBase
{
